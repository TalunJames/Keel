...
const CLIENT_KEYS = ['school', 'city', 'county', 'fire', 'special'];
...
<li>Deliver a written Final Campaign Report within 30 days of Election Day</li>
  ...
  schedule: () => `<table class="ptable"><thead><tr><th style="width:26%">Phase</th><th style="width:26%">Timeframe</th><th>Key Activities</th></tr></thead><tbody>
...
function defaultCostModel(ct) {
  ...
  return {
    ...
    cats: [
      ...
      { id: uid('k'), name: 'Travel', desc: 'All travel for community meetings, town halls, board presentations, and stakeholder engagement', fee: 7500, kind: 'flat', rec: 7500 },
    ],
    addOns: [
    ...
    passThroughs: [
      { id: uid('k'), name: 'Estimated Paid Media Spend', desc: 'Radio, digital, print, and out-of-home placements; pass-through at net cost, billed only against the approved media plan', fee: big ? 85000 : 0, on: big },
      { id: uid('k'), name: 'Direct Mail Production & Postage', desc: 'Universe-wide direct mail pieces: print production plus USPS postage at government rate; pass-through at vendor cost with no agency markup', fee: big ? 90000 : 0, on: big },
    ],
    personnel: [
